...
import { PayloadDisplayComponent } from './components/fragments/analysis-payload-dialog/steps/payload-display/payload-display.component';
import { PayloadFilterComponent } from './components/fragments/analysis-payload-dialog/steps/payload-filter/payload-filter.component';
import { PayloadGroupsComponent } from './components/fragments/analysis-payload-dialog/steps/payload-groups/payload-groups.component';
import { PayloadNarrativeComponent } from './components/fragments/analysis-payload-dialog/steps/payload-narrative/payload-narrative.component';
import { PayloadThresholdComponent } from './components/fragments/analysis-payload-dialog/steps/payload-threshold/payload-threshold.component';
import { StepHeaderComponent } from './components/fragments/analysis-payload-dialog/steps/step-header/step-header.component';
import { ReportResultSectionComponent } from './components/fragments/report-result-section/report-result-section.component';
import { AgeGroupsPipe } from './pipes/age-groups.pipe';
...
@NgModule({
  declarations: [
    ...
    PayloadDisplayComponent,
    PayloadFilterComponent,
    PayloadGroupsComponent,
    PayloadNarrativeComponent,
    PayloadThresholdComponent,
    StepHeaderComponent,
    ReportResultSectionComponent,
    AgeGroupsPipe,
  ],
  imports: [
    BrowserModule,
  ...
  providers: [
    ...
    { provide: 'BASE_URL', useValue: getBaseUrl, deps: [] },
  ],
  entryComponents: [
    AnalysisPayloadDialogComponent,
    AnalysisDialogComponent,
