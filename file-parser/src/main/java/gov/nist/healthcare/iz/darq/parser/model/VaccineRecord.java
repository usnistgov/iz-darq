...
public class VaccineRecord extends gov.nist.healthcare.iz.darq.parser.service.model.Record {
	...
	@Field(name="Event Information Source",index = 12, coded = true, table = "NIP001")
	...
	@Field(name="Administered Body Route",index = 13, coded = true, table = "0162_NCIT")
	public DqString admin_route;
	@Field(name="Administered Body Site",index = 14, coded = true, table = "0163")
	...
	@Field(name="Eligibility at Dose",index = 19, coded = true, table = "0064")
	public DqString eligibility_at_dose;
	@Field(name="Complete Status",index = 18, coded = true, table = "0322")
	public DqString complete_status;
	@Field(name="Vaccine Funding Source",index = 20, coded = true, table = "PHVS_ImmunizationFundingSource_IIS")
